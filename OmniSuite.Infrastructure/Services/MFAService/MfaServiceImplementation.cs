...
{
    public class MfaServiceImplementation : IMfaService
    {
        /// <summary>
        /// Gera um segredo TOTP e a URI OTP para uso com apps como Google Authenticator.
        /// </summary>
        public (string Secret, string QrCodeUri) GenerateMfaSecret(string email)
        {
        ...
        /// </summary>
        public string GenerateQrCodeSvg(string qrCodeUri)
        {
