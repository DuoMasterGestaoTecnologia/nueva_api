...
namespace OmniSuite.Persistence.Migrations
{
    ...
    [Migration("20250915142946_AddDigitalProductCategories")]
    partial class AddDigitalProductCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OmniSuite.Domain.Entities.ActiveTransactions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<int>("BuySellEnum")
                        .HasColumnType("int");

                    b.Property<long>("CurrentChartValue")
                    ...
                    b.ToTable("ActiveTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("OmniSuite.Domain.Entities.AffiliatesCommission", b =>
                {
                    ...
                    b.ToTable("AffiliatesCommission", (string)null);
                });
            ...
            modelBuilder.Entity("OmniSuite.Domain.Entities.DigitalProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("IsDigitalDelivery")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("DigitalProducts", (string)null);
                });

            modelBuilder.Entity("OmniSuite.Domain.Entities.DigitalProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("DigitalProductCategories", (string)null);
                });

            modelBuilder.Entity("OmniSuite.Domain.Entities.DigitalProductPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("DigitalProductPurchases", (string)null);
                });
            ...
            modelBuilder.Entity("OmniSuite.Domain.Entities.DigitalProduct", b =>
                {
                    b.HasOne("OmniSuite.Domain.Entities.DigitalProductCategory", "Category")
                        .WithMany("DigitalProducts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("OmniSuite.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("OmniSuite.Domain.Entities.DigitalProductPurchase", b =>
                {
                    b.HasOne("OmniSuite.Domain.Entities.DigitalProduct", "DigitalProduct")
                        .WithMany("Purchases")
